...
export const API_URL = 'https://api.foundershub.ai/api/v2/templates/ingest/cavzfgZsRTKyHnPgkb3uyYYOfCctKebx3KM11pLS/';

// CORS-friendly API URL to use in the application
export const PROXIED_API_URL = 'https://api.foundershub.ai/api/v2/templates/ingest/cavzfgZsRTKyHnPgkb3uyYYOfCctKebx3KM11pLS/';
