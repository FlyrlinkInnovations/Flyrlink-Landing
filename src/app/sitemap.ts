...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/become-expert`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.85 },
    ...
    { url: `${baseUrl}/payment-policy`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.3 },
    { url: `${baseUrl}/disclaimers`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.3 },
